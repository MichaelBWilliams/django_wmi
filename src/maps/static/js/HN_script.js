...
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.Name + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.Outstandin, "$")) + '</b><br/>' + 'Agriculture: <b>' + (format2(layer.feature.properties.Agricultur, "$")) + '</b><br/>' + 'Animal Husbandry: <b>' + (format2(layer.feature.properties.Animal, "$")) + '</b><br/>' + 'Industry: <b>' + (format2(layer.feature.properties.Industry, "$")) + '</b><br/>'  + 'Internal: <b>' + (format2(layer.feature.properties.Internal, "$")) + '</b><br/>' + 'Services: <b>' + (format2(layer.feature.properties.Services, "$")) + '</b><br/>' + 'Transport: <b>' + (format2(layer.feature.properties.Transport, "$")) + '</b><br/>')}, {direction: "center", className: "admLabel"});
