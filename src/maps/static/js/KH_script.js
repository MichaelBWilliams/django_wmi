...
var adm1Mini = L.geoJSON(KH_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 5, centerFixed: [12.922619, 104.969056]}).addTo(map);
// End mini map plugin
...
var branchLayer = L.geoJSON(KH_branchList, {
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.name + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.TotalUSD, "$")) + '</b><br/>' + 'Trade: <b>' + (format2(layer.feature.properties.Trade, "$")) + '</b><br/>' + 'Manufacturing: <b>' + (format2(layer.feature.properties.Manufactur, "$")) + '</b><br/>' + 'Service: <b>' + (format2(layer.feature.properties.Service, "$")) + '</b><br/>'  + 'Agriculture: <b>' + (format2(layer.feature.properties.Agricultur, "$")) + '</b><br/>' + 'Household: <b>' + (format2(layer.feature.properties.Household, "$")) + '</b><br/>' + 'Transportation: <b>' + (format2(layer.feature.properties.Transporta, "$")) + '</b><br/>')}, {direction: "center", className: "admLabel"});
