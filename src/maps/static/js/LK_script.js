...
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.name + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.Exposure, "$")) + '</b><br/>' + 'Agriculture: <b>' + (format2(layer.feature.properties.Agricultur, "$")) + '</b><br/>' + 'Building: <b>' + (format2(layer.feature.properties.Building, "$")) + '</b><br/>' + 'Child Well-Being: <b>' + (format2(layer.feature.properties.ChildWell, "$")) + '</b><br/>'  + 'Commerce: <b>' + (format2(layer.feature.properties.Commerce, "$")) + '</b><br/>' + 'Manufacturing: <b>' + (format2(layer.feature.properties.Manufactur, "$")) + '</b><br/>' + 'Service: <b>' + (format2(layer.feature.properties.Service, "$")) + '</b><br/>')}, {direction: "center", className: "admLabel"});
