...
var adm1Mini = L.geoJSON(TZ_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 4, centerFixed: [-6.401672, 34.8888]}).addTo(map);
// End mini map plugin
...
var branchLayer = L.geoJSON(TZ_branchList, {
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.BranchName + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.TotalUSD, "$")) + '</b><br/>' + 'Agriculture: <b>' + (format2(layer.feature.properties.Agricultur, "$")) + '</b><br/>' + 'Industry: <b>' + (format2(layer.feature.properties.Industry, "$")) + '</b><br/>' + 'Services: <b>' + (format2(layer.feature.properties.Services, "$")) + '</b><br/>'  + 'Trade: <b>' + (format2(layer.feature.properties.Trade, "$")) + '</b><br/>' + 'Household: <b>' + (format2(layer.feature.properties.Household, "$")) + '</b><br/>' + 'Education: <b>' + (format2(layer.feature.properties.Education, "$")) + '</b><br/>')}, {direction: "center", className: "admLabel"});
