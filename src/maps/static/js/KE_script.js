...
var adm1Mini = L.geoJSON(KE_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 4, centerFixed: [0.748396, 37.826069]}).addTo(map);
// End mini map plugin
...
var branchLayer = L.geoJSON(KE_branchList, {
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.name + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.OutAmtUSD, "$")) + '</b><br/>' + 'Agriculture: <b>' + (format2(layer.feature.properties.Agricultur, "$")) + '</b><br/>' + 'Asset Loan: <b>' + (format2(layer.feature.properties.Asset, "$")) + '</b><br/>' + 'Business: <b>' + (format2(layer.feature.properties.Business, "$")) + '</b><br/>'  + 'Education: <b>' + (format2(layer.feature.properties.Education, "$")) + '</b><br/>' + 'Livelihood: <b>' + (format2(layer.feature.properties.Livelihood, "$")) + '</b><br/>' + 'El Nino Loan: <b>' + (format2(layer.feature.properties.ElNinoLoan, "$")) + '</b><br/>')}, {direction: "center", className: "admLabel"});
