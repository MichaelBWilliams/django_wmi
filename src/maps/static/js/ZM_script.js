...
var adm1Mini = L.geoJSON(ZM_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 4, centerFixed: [-13.080394, 27.959163]}).addTo(map);
// End mini map plugin
