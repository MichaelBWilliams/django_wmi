...
}).bindPopup(function(layer){return String('<b>' + layer.feature.properties.BranchName + '</b><br/>' + 'Outstanding Portfolio 2016 (USD): <br/>' + 'Total: <b>' + (format2(layer.feature.properties.TotalUSD, "$")) + '</b>')}, {direction: "center", className: "admLabel"});
