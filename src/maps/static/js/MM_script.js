...
var adm1Mini = L.geoJSON(MM_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 3, centerFixed: [19.793442, 96.433264]}).addTo(map);
// End mini map plugin
