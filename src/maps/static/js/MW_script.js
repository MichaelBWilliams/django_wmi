...
var adm1Mini = L.geoJSON(MW_adm1, {
	style: adm1StyleMini
});
var layers = new L.LayerGroup([osm2, adm1Mini]);
var miniMap = new L.Control.MiniMap(layers, {toggleDisplay: true, zoomLevelFixed: 4, centerFixed: [-13.2543, 34.3015]}).addTo(map);
// End mini map plugin
...
var branchLayer = L.geoJSON(MW_branchList, {
